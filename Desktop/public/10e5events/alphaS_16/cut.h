...
// Mon Apr 12 15:51:23 2021 by ROOT version 6.22/06
...
Int_t cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cut::LoadTree(Long64_t entry)
{
