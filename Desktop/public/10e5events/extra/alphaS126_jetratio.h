...
// Thu Apr 29 16:12:24 2021 by ROOT version 6.22/06
// from TTree events/events
// found on file: ISRoff_alphaS126_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS126_jetratio_h
#define alphaS126_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS126_jetratio(TTree *tree=0);
   virtual ~alphaS126_jetratio();
...
#ifdef alphaS126_jetratio_cxx
alphaS126_jetratio::alphaS126_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS126_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS126_R5.root");
      }
...
alphaS126_jetratio::~alphaS126_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS126_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS126_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS126_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS126_jetratio::Notify()
{
...
void alphaS126_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS126_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS126_jetratio_cxx
