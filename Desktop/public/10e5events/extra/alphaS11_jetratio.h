...
// Fri Apr 30 23:18:26 2021 by ROOT version 6.24/00
// from TTree events/events
// found on file: ISRoff_alphaS11_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS11_jetratio_h
#define alphaS11_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS11_jetratio(TTree *tree=0);
   virtual ~alphaS11_jetratio();
...
#ifdef alphaS11_jetratio_cxx
alphaS11_jetratio::alphaS11_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS11_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS11_R5.root");
      }
...
alphaS11_jetratio::~alphaS11_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS11_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS11_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS11_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS11_jetratio::Notify()
{
...
void alphaS11_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS11_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS11_jetratio_cxx
