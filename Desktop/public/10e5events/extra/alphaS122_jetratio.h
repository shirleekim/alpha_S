...
// Wed Apr 28 18:26:23 2021 by ROOT version 6.19/02
// from TTree events/events
// found on file: ISRoff_alphaS122_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS122_jetratio_h
#define alphaS122_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS122_jetratio(TTree *tree=0);
   virtual ~alphaS122_jetratio();
...
#ifdef alphaS122_jetratio_cxx
alphaS122_jetratio::alphaS122_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS122_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS122_R5.root");
      }
...
alphaS122_jetratio::~alphaS122_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS122_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS122_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS122_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS122_jetratio::Notify()
{
...
void alphaS122_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS122_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS122_jetratio_cxx
