...
// Wed Apr 28 18:26:58 2021 by ROOT version 6.19/02
// from TTree events/events
// found on file: ISRoff_alphaS125_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS125_jetratio_h
#define alphaS125_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS125_jetratio(TTree *tree=0);
   virtual ~alphaS125_jetratio();
...
#ifdef alphaS125_jetratio_cxx
alphaS125_jetratio::alphaS125_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS125_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS125_R5.root");
      }
...
alphaS125_jetratio::~alphaS125_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS125_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS125_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS125_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS125_jetratio::Notify()
{
...
void alphaS125_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS125_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS125_jetratio_cxx
