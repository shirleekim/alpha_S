...
// Mon May  3 15:15:46 2021 by ROOT version 6.24/00
// from TTree events/events
// found on file: ISRoff_alphaS113_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS113_jetratio_h
#define alphaS113_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS113_jetratio(TTree *tree=0);
   virtual ~alphaS113_jetratio();
...
#ifdef alphaS113_jetratio_cxx
alphaS113_jetratio::alphaS113_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS113_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS113_R5.root");
      }
...
alphaS113_jetratio::~alphaS113_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS113_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS113_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS113_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS113_jetratio::Notify()
{
...
void alphaS113_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS113_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS113_jetratio_cxx
