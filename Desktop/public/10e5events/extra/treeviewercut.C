...
//=========for tree "jetratio" (Fri Apr 30 21:50:38 2021)
...
//   Cut expression
   ...
   item->SetExpression("R==0.5 && Jet_algorithm==0 && E_cut==10 && theta_cut==0", "~cut, no theta");
//         Scan list
   item = treeview->ExpressionItem(4);
   item->SetExpression("", "Scan box");
//         User defined expressions
   item = treeview->ExpressionItem(5);
   item->SetExpression("R==0.5 && Jet_algorithm==0 && E_cut==10 && theta_cut==0", "~cut, no theta", kTRUE);
