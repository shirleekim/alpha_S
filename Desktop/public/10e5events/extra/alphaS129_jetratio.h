...
// Mon May  3 15:17:08 2021 by ROOT version 6.24/00
// from TTree events/events
// found on file: ISRoff_alphaS129_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS129_jetratio_h
#define alphaS129_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS129_jetratio(TTree *tree=0);
   virtual ~alphaS129_jetratio();
...
#ifdef alphaS129_jetratio_cxx
alphaS129_jetratio::alphaS129_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS129_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS129_R5.root");
      }
...
alphaS129_jetratio::~alphaS129_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS129_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS129_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS129_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS129_jetratio::Notify()
{
...
void alphaS129_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS129_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS129_jetratio_cxx
