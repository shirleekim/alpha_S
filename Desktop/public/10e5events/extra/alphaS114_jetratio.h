...
// Thu Apr 29 16:12:09 2021 by ROOT version 6.22/06
// from TTree events/events
// found on file: ISRoff_alphaS114_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS114_jetratio_h
#define alphaS114_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS114_jetratio(TTree *tree=0);
   virtual ~alphaS114_jetratio();
...
#ifdef alphaS114_jetratio_cxx
alphaS114_jetratio::alphaS114_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaS114_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaS114_R5.root");
      }
...
alphaS114_jetratio::~alphaS114_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS114_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS114_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS114_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS114_jetratio::Notify()
{
...
void alphaS114_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS114_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS114_jetratio_cxx
