...
// Fri Apr 30 23:17:29 2021 by ROOT version 6.24/00
// from TTree events/events
// found on file: ISRoff_alphaSdefault_R5.root
//////////////////////////////////////////////////////////

#ifndef alphaS1365_jetratio_h
#define alphaS1365_jetratio_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   alphaS1365_jetratio(TTree *tree=0);
   virtual ~alphaS1365_jetratio();
...
#ifdef alphaS1365_jetratio_cxx
alphaS1365_jetratio::alphaS1365_jetratio(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff_alphaSdefault_R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff_alphaSdefault_R5.root");
      }
...
alphaS1365_jetratio::~alphaS1365_jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t alphaS1365_jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t alphaS1365_jetratio::LoadTree(Long64_t entry)
{
...
void alphaS1365_jetratio::Init(TTree *tree)
{
...
Bool_t alphaS1365_jetratio::Notify()
{
...
void alphaS1365_jetratio::Show(Long64_t entry)
{
...
Int_t alphaS1365_jetratio::Cut(Long64_t entry)
{
...
#endif // #ifdef alphaS1365_jetratio_cxx
