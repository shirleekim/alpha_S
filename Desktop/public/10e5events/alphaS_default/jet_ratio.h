...
// Wed Apr 14 18:19:54 2021 by ROOT version 6.22/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   jet_ratio(TTree *tree=0);
   virtual ~jet_ratio();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(double r_cone);
...
#ifdef jet_ratio_cxx
jet_ratio::jet_ratio(TTree *tree) : fChain(0)
{
...
Int_t jet_ratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t jet_ratio::LoadTree(Long64_t entry)
{
...
void jet_ratio::Init(TTree *tree)
{
...
void jet_ratio::Show(Long64_t entry)
{
...
Int_t jet_ratio::Cut(Long64_t entry)
{
