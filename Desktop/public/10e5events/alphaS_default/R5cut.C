...
TText *theta_range = new TText(0.7, 0.65, Form("#theta in range [%.1f, %.1f]",theta_min,theta_max));
theta_range->SetNDC(); // text position defined within [0,1]
theta_range->SetTextSize(0.03);
theta_range->SetTextColor(kRed);

TText *without_theta = new TText(0.7, 0.75, "#theta in range [0, #PI]");
without_theta->SetNDC(); // text position defined within [0,1]
...
for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   c1->Update();
   //c1->Draw();
   c1->SaveAs(Form("valencia_graphs/R%d_valencia_pT%d.png",r,pTcut));
   ...
   c2->Update();
 //  c2->Draw();
   c2->SaveAs(Form("valencia_graphs/R%d_valencia_E%d.png",r,Ecut));
...
////////without theta cut////////////
   ...
   without_theta->Draw();
   c5->Update();
   c5->SaveAs(Form("valencia_graphs/R%d_valencia_thetaE_pT%d.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c6->Update();
   c6->SaveAs(Form("valencia_graphs/R%d_valencia_thetapT_E%d.png",r,Ecut));
/////////end of without theta cut
...
///////with theta cut ////////
   ...
   theta_range->Draw();
   c9->Update();
   c9->SaveAs(Form("valencia_graphs/R%d_valencia_thetaE_pT%d_thetacut.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c10->Update();
   c10->SaveAs(Form("valencia_graphs/R%d_valencia_thetapT_E%d_thetacut.png",r,Ecut));
///////end of with theta cut
*/
...
// analysis of number of jets, R_{3/2}
 ...
 //  max_nb_jets = (int)(*hist_nb_jets_Ecut).GetXaxis()->GetXmax();
   ...
   jetratiopT2->Draw();
   c7->Update();
   c7->SaveAs(Form("valencia_graphs/R%d_valencia_nb_jets_pT%d.png",r,pTcut));
   ...
   jetratioE2->Draw();
   c8->Update();
   c8->SaveAs(Form("valencia_graphs/R%d_valencia_nb_jets_E%d.png",r,Ecut));
...
//      c3->SaveAs(Form("valencia_graphs/R%d_valencia_theta_distritution_pT%d.png",r,pTcut));
...
//      c4->SaveAs(Form("valencia_graphs/R%d_valencia_theta_distritution_E%d.png",r,Ecut));
 ...
 c3->SaveAs(Form("valencia_graphs/R%d_valencia_theta_distritution_pTcut.png",r));
 c4->SaveAs(Form("valencia_graphs/R%d_valencia_theta_distritution_Ecut.png",r));

}
void R5cut::Loop_cambridge()
{
...
for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   c1->Update();
   //c1->Draw();
   c1->SaveAs(Form("cambridge_graphs/R%d_cambridge_pT%d.png",r,pTcut));
   ...
   c2->Update();
 //  c2->Draw();
   c2->SaveAs(Form("cambridge_graphs/R%d_cambridge_E%d.png",r,Ecut));
...
////////without theta cut////////////
   ...
   without_theta->Draw();
   c5->Update();
   c5->SaveAs(Form("cambridge_graphs/R%d_cambridge_thetaE_pT%d.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c6->Update();
   c6->SaveAs(Form("cambridge_graphs/R%d_cambridge_thetapT_E%d.png",r,Ecut));
/////////end of without theta cut
...
///////with theta cut ////////
   ...
   theta_range->Draw();
   c9->Update();
   c9->SaveAs(Form("cambridge_graphs/R%d_cambridge_thetaE_pT%d_thetacut.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c10->Update();
   c10->SaveAs(Form("cambridge_graphs/R%d_cambridge_thetapT_E%d_thetacut.png",r,Ecut));
///////end of with theta cut
*/
...
// analysis of number of jets, R_{3/2}
 ...
 //  max_nb_jets = (int)(*hist_nb_jets_Ecut).GetXaxis()->GetXmax();
   ...
   jetratiopT2->Draw();
   c7->Update();
   c7->SaveAs(Form("cambridge_graphs/R%d_cambridge_nb_jets_pT%d.png",r,pTcut));
   ...
   jetratioE2->Draw();
   c8->Update();
   c8->SaveAs(Form("cambridge_graphs/R%d_cambridge_nb_jets_E%d.png",r,Ecut));
...
//      c3->SaveAs(Form("cambridge_graphs/R%d_cambridge_theta_distritution_pT%d.png",r,pTcut));
...
//      c4->SaveAs(Form("cambridge_graphs/R%d_cambridge_theta_distritution_E%d.png",r,Ecut));
 ...
 c3->SaveAs(Form("cambridge_graphs/R%d_cambridge_theta_distritution_pTcut.png",r));
 c4->SaveAs(Form("cambridge_graphs/R%d_cambridge_theta_distritution_Ecut.png",r));
...
for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   c1->Update();
   //c1->Draw();
   c1->SaveAs(Form("kt_graphs/R%d_kt_pT%d.png",r,pTcut));
   ...
   c2->Update();
 //  c2->Draw();
   c2->SaveAs(Form("kt_graphs/R%d_kt_E%d.png",r,Ecut));
...
////////without theta cut////////////
   ...
   without_theta->Draw();
   c5->Update();
   c5->SaveAs(Form("kt_graphs/R%d_kt_thetaE_pT%d.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c6->Update();
   c6->SaveAs(Form("kt_graphs/R%d_kt_thetapT_E%d.png",r,Ecut));
/////////end of without theta cut
...
///////with theta cut ////////
   ...
   theta_range->Draw();
   c9->Update();
   c9->SaveAs(Form("kt_graphs/R%d_kt_thetaE_pT%d_thetacut.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c10->Update();
   c10->SaveAs(Form("kt_graphs/R%d_kt_thetapT_E%d_thetacut.png",r,Ecut));
///////end of with theta cut
*/
...
// analysis of number of jets, R_{3/2}
 ...
 //  max_nb_jets = (int)(*hist_nb_jets_Ecut).GetXaxis()->GetXmax();
   ...
   jetratiopT2->Draw();
   c7->Update();
   c7->SaveAs(Form("kt_graphs/R%d_kt_nb_jets_pT%d.png",r,pTcut));
   ...
   jetratioE2->Draw();
   c8->Update();
   c8->SaveAs(Form("kt_graphs/R%d_kt_nb_jets_E%d.png",r,Ecut));
...
//      c3->SaveAs(Form("kt_graphs/R%d_kt_theta_distritution_pT%d.png",r,pTcut));
...
//      c4->SaveAs(Form("kt_graphs/R%d_kt_theta_distritution_E%d.png",r,Ecut));
 ...
 c3->SaveAs(Form("kt_graphs/R%d_kt_theta_distritution_pTcut.png",r));
 c4->SaveAs(Form("kt_graphs/R%d_kt_theta_distritution_Ecut.png",r));

}

void R5cut::Loop_ee_genkt()
{
...
for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   c1->Update();
   //c1->Draw();
   c1->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_pT%d.png",r,pTcut));
   ...
   c2->Update();
 //  c2->Draw();
   c2->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_E%d.png",r,Ecut));
...
////////without theta cut////////////
   ...
   without_theta->Draw();
   c5->Update();
   c5->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_thetaE_pT%d.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c6->Update();
   c6->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_thetapT_E%d.png",r,Ecut));
/////////end of without theta cut
...
///////with theta cut ////////
   ...
   theta_range->Draw();
   c9->Update();
   c9->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_thetaE_pT%d_thetacut.png",r,Ecut));
   ...
   t_Ecut->Draw();
   c10->Update();
   c10->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_thetapT_E%d_thetacut.png",r,Ecut));
///////end of with theta cut
*/
...
// analysis of number of jets, R_{3/2}
 ...
 //  max_nb_jets = (int)(*hist_nb_jets_Ecut).GetXaxis()->GetXmax();
   ...
   jetratiopT2->Draw();
   c7->Update();
   c7->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_nb_jets_pT%d.png",r,pTcut));
   ...
   jetratioE2->Draw();
   c8->Update();
   c8->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_nb_jets_E%d.png",r,Ecut));
...
//      c3->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_theta_distritution_pT%d.png",r,pTcut));
...
//      c4->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_theta_distritution_E%d.png",r,Ecut));
 ...
 c3->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_theta_distritution_pTcut.png",r));
 c4->SaveAs(Form("ee_genkt_graphs/R%d_ee_genkt_theta_distritution_Ecut.png",r));
