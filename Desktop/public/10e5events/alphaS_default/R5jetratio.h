...
// Tue Apr 20 17:15:54 2021 by ROOT version 6.22/08
// from TTree events/events
// found on file: ISRoff__R5.root
//////////////////////////////////////////////////////////
...
#ifdef R5jetratio_cxx
R5jetratio::R5jetratio(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff__R5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff__R5.root");
      }
...
R5jetratio::~R5jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t R5jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R5jetratio::LoadTree(Long64_t entry)
{
...
void R5jetratio::Init(TTree *tree)
{
...
void R5jetratio::Show(Long64_t entry)
{
...
Int_t R5jetratio::Cut(Long64_t entry)
{
