#define R6jetratio_cxx
#include "R6jetratio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void R6jetratio::Loop_antikt()
{
...
void R6jetratio::Loop_cambridge()
{
if (fChain == 0) return;
