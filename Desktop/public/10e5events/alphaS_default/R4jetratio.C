#define R4jetratio_cxx
#include "R4jetratio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void R4jetratio::Loop_antikt()
{
...
void R4jetratio::Loop_cambridge()
{
if (fChain == 0) return;
