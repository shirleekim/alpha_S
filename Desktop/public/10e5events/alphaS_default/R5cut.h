...
// Fri Apr 23 11:13:23 2021 by ROOT version 6.19/02
...
#ifdef R5cut_cxx
R5cut::R5cut(TTree *tree) : fChain(0)
{
...
Int_t R5cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R5cut::LoadTree(Long64_t entry)
{
...
void R5cut::Show(Long64_t entry)
{
...
Int_t R5cut::Cut(Long64_t entry)
{
