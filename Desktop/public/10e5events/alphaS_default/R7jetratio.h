...
// Tue Apr 20 17:16:26 2021 by ROOT version 6.22/08
// from TTree events/events
// found on file: ISRoff__R7.root
//////////////////////////////////////////////////////////
...
#ifdef R7jetratio_cxx
R7jetratio::R7jetratio(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff__R7.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff__R7.root");
      }
...
R7jetratio::~R7jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t R7jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R7jetratio::LoadTree(Long64_t entry)
{
...
void R7jetratio::Init(TTree *tree)
{
...
void R7jetratio::Show(Long64_t entry)
{
...
Int_t R7jetratio::Cut(Long64_t entry)
{
