...
// Tue Apr 20 17:15:22 2021 by ROOT version 6.22/08
// from TTree events/events
// found on file: ISRoff__R4.root
//////////////////////////////////////////////////////////
...
#ifdef R4jetratio_cxx
R4jetratio::R4jetratio(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff__R4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff__R4.root");
      }
...
R4jetratio::~R4jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t R4jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R4jetratio::LoadTree(Long64_t entry)
{
...
void R4jetratio::Init(TTree *tree)
{
...
void R4jetratio::Show(Long64_t entry)
{
...
Int_t R4jetratio::Cut(Long64_t entry)
{
