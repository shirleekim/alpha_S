...
void jet_ratio::Loop(double r_cone)
{
...
////only wh
      ...
      TH2F* hist_jetratio_pT = new TH2F(Form("hist_jetratio_pTcut%d_withoutthetacut",pTcut), "Jet ratio in function of pT cut ; pT cut(GeV); Jet ratio",60, 0.,30.,100,0.,1.);
      TH2F* hist_jetratio_E = new TH2F(Form("hist_jetratio_Ecut%d_withoutthetacut",Ecut), "Jet ratio in function of E cut ; E cut(GeV); Jet ratio",60, 0.,30.,100,0.,1.);

      TH2F* hist_jetratio_pT2 = new TH2F(Form("hist_jetratio_pTcut%d",pTcut), "Jet ratio in function of pT cut ; pT cut(GeV); Jet ratio",60, 0.,30.,100,0.,1.);
      TH2F* hist_jetratio_E2 = new TH2F(Form("hist_jetratio_Ecut%d",Ecut), "Jet ratio in function of E cut ; E cut(GeV); Jet ratio",60, 0.,30.,100,0.,1.);
...
////////////////////////////////////
   ...
   for(int i=0; i<size; i++)
   {
    ...
    //theta cut histogram
       TH1D* hist_nb_jets_pTcut2 = new TH1D(Form("hist_nb_jets_pTcut%d_2",pTcut), "Number of jets ; Number of jets; Counts",60,0.,30.);
       TH1D* hist_nb_jets_Ecut2 = new TH1D(Form("hist_nb_jets_Ecut%d_2",Ecut), "Number of jets ; Number of jets; Counts", 60,0.,30.);

    //////end of theta cut histogram


   Long64_t nbytes = 0, nb = 0;
   //Loop for every events
