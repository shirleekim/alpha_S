...
// Tue Apr 20 17:16:13 2021 by ROOT version 6.22/08
// from TTree events/events
// found on file: ISRoff__R6.root
//////////////////////////////////////////////////////////
...
#ifdef R6jetratio_cxx
R6jetratio::R6jetratio(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ISRoff__R6.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ISRoff__R6.root");
      }
...
R6jetratio::~R6jetratio()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t R6jetratio::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R6jetratio::LoadTree(Long64_t entry)
{
...
void R6jetratio::Init(TTree *tree)
{
...
void R6jetratio::Show(Long64_t entry)
{
...
Int_t R6jetratio::Cut(Long64_t entry)
{
