#define R3jetratio_cxx
#include "R3jetratio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void R3jetratio::Loop_antikt()
{
...
void R3jetratio::Loop_cambridge()
{
if (fChain == 0) return;
