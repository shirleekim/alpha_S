...
// Mon Apr 19 12:45:26 2021 by ROOT version 6.19/02
...
#ifdef recoMass_cxx
recoMass::recoMass(TTree *tree) : fChain(0) 
{
...
Int_t recoMass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t recoMass::LoadTree(Long64_t entry)
{
...
void recoMass::Show(Long64_t entry)
{
...
Int_t recoMass::Cut(Long64_t entry)
{
