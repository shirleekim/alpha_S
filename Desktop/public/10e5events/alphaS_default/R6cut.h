...
// Fri Apr 23 11:13:34 2021 by ROOT version 6.19/02
...
#ifdef R6cut_cxx
R6cut::R6cut(TTree *tree) : fChain(0)
{
...
Int_t R6cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R6cut::LoadTree(Long64_t entry)
{
...
void R6cut::Show(Long64_t entry)
{
...
Int_t R6cut::Cut(Long64_t entry)
{
