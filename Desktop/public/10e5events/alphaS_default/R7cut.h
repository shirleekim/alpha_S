...
// Fri Apr 23 11:13:44 2021 by ROOT version 6.19/02
...
#ifdef R7cut_cxx
R7cut::R7cut(TTree *tree) : fChain(0)
{
...
Int_t R7cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R7cut::LoadTree(Long64_t entry)
{
...
void R7cut::Show(Long64_t entry)
{
...
Int_t R7cut::Cut(Long64_t entry)
{
