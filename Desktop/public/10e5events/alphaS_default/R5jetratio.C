#define R5jetratio_cxx
#include "R5jetratio.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void R5jetratio::Loop_antikt()
{
...
Int_t Ecut = 0;
Int_t pTcut= 0;
//Double_t Ecuts[] = {0,5,10,15,20,25};
Double_t pTcuts[] = {0};
...
Int_t size = sizeof(Ecuts)/sizeof(Ecuts[0]);
...
TText *theta_range = new TText(0.3, 0.75, Form("#theta in range [%.1f, %.1f]",theta_min,theta_max));
theta_range->SetNDC(); // text position defined within [0,1]
theta_range->SetTextSize(0.03);
theta_range->SetTextColor(kRed);

TText *without_theta = new TText(0.6, 0.8, "#theta in range [0, #PI]");
...
////only wh
   ...
   TH2F* hist_jetratio_pT = new TH2F(Form("hist_jetratio_pTcut%d_withoutthetacut",pTcut), "R_{3/2} in function of pT cut (antikt); pT cut(GeV); R_{3/2}",60, 0.,30.,100,0.,1.);
   TH2F* hist_jetratio_E = new TH2F(Form("hist_jetratio_Ecut%d_withoutthetacut",Ecut), "R_{3/2} in function of E cut (antikt); E cut(GeV); R_{3/2}",60, 0.,30.,100,0.,1.);

   TH2F* hist_jetratio_pT2 = new TH2F(Form("hist_jetratio_pTcut%d",pTcut), "R_{3/2} in function of pT cut (antikt); pT cut(GeV); R_{3/2}",60, 0.,30.,100,0.,1.);
   TH2F* hist_jetratio_E2 = new TH2F(Form("hist_jetratio_Ecut%d",Ecut), "R_{3/2} in function of E cut (antikt); E cut(GeV); R_{3/2}",60, 0.,30.,100,0.,1.);
...
//    hist_jetratio_pT2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c1->Update();
   c1->SaveAs(Form("antikt_graphs/jetratio/R%d_jetratio_pTcut_notheta.png",r));
...
//    hist_jetratio_E2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c2->Update();
   c2->SaveAs(Form("antikt_graphs/jetratio/R%d_jetratio_Ecut_notheta.png",r));
 ...
 //  without_theta->Draw();
   c3->Update();
   c3->SaveAs(Form("antikt_graphs/jetratio/R%d_jetratio_pTcut_theta.png",r));
   ...
   //without_theta->Draw();
   c4->Update();
   c4->SaveAs(Form("antikt_graphs/jetratio/R%d_jetratio_Ecut_theta.png",r));
   ...
   conesize->Draw();
   c5->Update();
   c5->SaveAs(Form("antikt_graphs/jetratio/R%d_jetratio_E_and_pT_thetacut.png",r));
...
//    hist_jetratio_pT2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c1->Update();
   c1->SaveAs(Form("kt_graphs/jetratio/R%d_jetratio_pTcut_notheta.png",r));
...
//    hist_jetratio_E2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c2->Update();
   c2->SaveAs(Form("kt_graphs/jetratio/R%d_jetratio_Ecut_notheta.png",r));
 ...
 //  without_theta->Draw();
   c3->Update();
   c3->SaveAs(Form("kt_graphs/jetratio/R%d_jetratio_pTcut_theta.png",r));
   ...
   //without_theta->Draw();
   c4->Update();
   c4->SaveAs(Form("kt_graphs/jetratio/R%d_jetratio_Ecut_theta.png",r));
   ...
   conesize->Draw();
   c5->Update();
   c5->SaveAs(Form("kt_graphs/jetratio/R%d_jetratio_E_and_pT_thetacut.png",r));
...
//    hist_jetratio_pT2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c1->Update();
   c1->SaveAs(Form("ee_genkt_graphs/jetratio/R%d_jetratio_pTcut_notheta.png",r));
...
//    hist_jetratio_E2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c2->Update();
   c2->SaveAs(Form("ee_genkt_graphs/jetratio/R%d_jetratio_Ecut_notheta.png",r));
 ...
 //  without_theta->Draw();
   c3->Update();
   c3->SaveAs(Form("ee_genkt_graphs/jetratio/R%d_jetratio_pTcut_theta.png",r));
   ...
   //without_theta->Draw();
   c4->Update();
   c4->SaveAs(Form("ee_genkt_graphs/jetratio/R%d_jetratio_Ecut_theta.png",r));
   ...
   conesize->Draw();
   c5->Update();
   c5->SaveAs(Form("ee_genkt_graphs/jetratio/R%d_jetratio_E_and_pT_thetacut.png",r));
...
void R5jetratio::Loop_cambridge()
{
//   In a ROOT session, you can do:
//      root> .L R5jetratio.C
//      root> R5jetratio t
...
//    hist_jetratio_pT2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c1->Update();
   c1->SaveAs(Form("cambridge_graphs/jetratio/R%d_jetratio_pTcut_notheta.png",r));
...
//    hist_jetratio_E2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c2->Update();
   c2->SaveAs(Form("cambridge_graphs/jetratio/R%d_jetratio_Ecut_notheta.png",r));
 ...
 //  without_theta->Draw();
   c3->Update();
   c3->SaveAs(Form("cambridge_graphs/jetratio/R%d_jetratio_pTcut_theta.png",r));
   ...
   //without_theta->Draw();
   c4->Update();
   c4->SaveAs(Form("cambridge_graphs/jetratio/R%d_jetratio_Ecut_theta.png",r));
   ...
   conesize->Draw();
   c5->Update();
   c5->SaveAs(Form("cambridge_graphs/jetratio/R%d_jetratio_E_and_pT_thetacut.png",r));
...
//    hist_jetratio_pT2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c1->Update();
   c1->SaveAs(Form("valencia_graphs/jetratio/R%d_jetratio_pTcut_notheta.png",r));
...
//    hist_jetratio_E2->Draw("SAME");
 ...
 //  theta_range->Draw();
   without_theta->Draw();
   c2->Update();
   c2->SaveAs(Form("valencia_graphs/jetratio/R%d_jetratio_Ecut_notheta.png",r));
 ...
 //  without_theta->Draw();
   c3->Update();
   c3->SaveAs(Form("valencia_graphs/jetratio/R%d_jetratio_pTcut_theta.png",r));
   ...
   //without_theta->Draw();
   c4->Update();
   c4->SaveAs(Form("valencia_graphs/jetratio/R%d_jetratio_Ecut_theta.png",r));
   ...
   conesize->Draw();
   c5->Update();
   c5->SaveAs(Form("valencia_graphs/jetratio/R%d_jetratio_E_and_pT_thetacut.png",r));
