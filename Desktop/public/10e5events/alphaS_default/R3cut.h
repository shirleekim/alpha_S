...
// Fri Apr 23 11:12:52 2021 by ROOT version 6.19/02
...
#ifdef R3cut_cxx
R3cut::R3cut(TTree *tree) : fChain(0)
{
...
Int_t R3cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R3cut::LoadTree(Long64_t entry)
{
...
void R3cut::Show(Long64_t entry)
{
...
Int_t R3cut::Cut(Long64_t entry)
{
