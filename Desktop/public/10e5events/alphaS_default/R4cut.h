...
// Fri Apr 23 11:13:07 2021 by ROOT version 6.19/02
...
#ifdef R4cut_cxx
R4cut::R4cut(TTree *tree) : fChain(0)
{
...
Int_t R4cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t R4cut::LoadTree(Long64_t entry)
{
...
void R4cut::Show(Long64_t entry)
{
...
Int_t R4cut::Cut(Long64_t entry)
{
